<?php
$this->assign('description', $ward_ja . 'のリノベーション&amp;リフォーム済中古マンション特集・');
$this->assign('keywords', $ward_ja . ',リノベーション,リフォーム,');
$this->assign('title', $ward_ja . 'のリノベーション&amp;リフォーム済中古マンション特集｜');
?>

<section id="mainVisualTc">
	<div id="mainVisualTcInr" class="mainVisualTcRenovationsBg">
		<h1><?php echo h($ward_ja); ?><br>リノベーション&amp;リフォーム済<br>中古マンション</h1>
	</div>
</section>
...
<div id="bread">
	<ul>
		<li><a href="/">home</a></li>
		<li class="current"><?php echo h($ward_ja); ?>のリノベーション</li>
	</ul>
</div><!-- /#bread -->
...
<h2 class="sub-title"><?php echo h($ward_ja); ?>のリノベーション&amp;リフォーム済中古マンション特集</h2>

<?php if ($articlesData): ?>
	<?php echo $this->element('modules/pagenate', array('here' => '/renovations/' . $ward . '/'));//if ($this->SiteUtil->chkArtQuant($articlesData)) echo $this->element('modules/pagenate', array()); ?>
	...
	<?php echo $this->element('modules/pagenate', array('here' => '/renovations/' . $ward . '/')); ?>
<?php else: ?>
