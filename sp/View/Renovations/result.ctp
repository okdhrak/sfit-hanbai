...
<section>
	<div id="mainVisual">
		<div id="titleArea">
			<h1><span class="unit01"><?php echo h($ward_ja); ?></span><span class="unit02" style="font-size:1.4em; margin-bottom:60px; line-height:1.5em;">リノベーション&amp;リフォーム済<br>中古マンション特集</span></h1>
		</div>
	</div>
</section>
...
<?php if (@$print === '123456789') : //様子をみて削除 ?>
<section>
...
<div id="content">
	...
	<?php if ($articlesData): ?>
		<?php echo $this->element('modules/pagenate', array('count' => count($articlesCount), 'here' => '/sp/renovations/' . $ward . '/')); ?>
